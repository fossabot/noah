...
func (ctx *NSettings) SetSetting(SettingName string, SettingValue interface{}) (error) {
...
func (ctx *NSettings) GetSettingInt64(SettingName string) (*int64, error) {
	if _, ok := settingsKeys[NoahSetting(SettingName)]; !ok {
