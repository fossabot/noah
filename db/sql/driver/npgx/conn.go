...
func connect(config ConnConfig, connInfo *types.ConnInfo) (c *Conn, err error) {
	c = new(Conn)
...
func (c *Conn) connect(config ConnConfig, network, address string, dial DialFunc) (err error) {
